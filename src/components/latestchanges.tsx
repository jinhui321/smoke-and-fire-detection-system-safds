              ...
              <>
                ...
                <div className="text-white">
                  ...
                  {currentDetections.length > 0 ? (
                    <div className="mt-2">
                      <p className="text-sm text-gray-400">Current Detections:</p>
                ...
                {/* Download Buttons - moved here under detections */}
                <div className="mt-4 space-y-3">
                  <button
                    onClick={() => downloadFile(annotatedVideoPath || '', `annotated_video_${new Date().toISOString().slice(0, 19).replace(/:/g, '-')}.mp4`)}
                    disabled={!annotatedVideoPath}
                    className="px-6 py-3 bg-green-600 hover:bg-green-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors flex items-center gap-2 mx-auto"
                  >
                ...
                {/* Processing indicator moved to bottom */}
                <div className="mt-6">
